...
class gsp_fragDenIng_angebotedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/angebot/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'angebot.label', default: 'Angebot'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',27,['bean':(angebotInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',29,['bean':(angebotInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("version"),'value':(angebotInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',38,['url':([resource:angebotInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(24)
})
