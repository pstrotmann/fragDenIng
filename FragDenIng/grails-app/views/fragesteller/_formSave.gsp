...
<li class="add">
<g:link controller="frage" action="create" params="['fragesteller.id': fragestellerInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'frage.label', default: 'Frage')])}</g:link>
</li>
</ul>
...
<div class="fieldcontain ${hasErrors(bean: fragestellerInstance, field: 'passwort', 'error')} required">
	<label for="passwort">
...
<div class="fieldcontain ${hasErrors(bean: fragestellerInstance, field: 'sprache', 'error')} required">
	<label for="sprache">
...
<div class="fieldcontain ${hasErrors(bean: fragestellerInstance, field: 'partner', 'error')}">
	<label for="partner">
		<g:message code="experte.partner.label" default="Fragesteller zur Auswahl" />
		</label>
